...
public class Player {
    ...
    private final GameEnder gameEnder;
    private final PrintStream printStream;
    private final ValidInputReader inputReader;
    private final List<Player> otherPlayer;

    public Player(String symbol, String number, Board board, GameEnder gameEnder, PrintStream printStream, ValidInputReader inputReader, List<Player> otherPlayer) {
        this.symbol = symbol;
        this.number = number;
        this.board = board;
